...
const { createDeferredPromise } = require('undici/lib/util/promise')
const { environmentSettingsObject } = require('undici/lib/web/fetch/util')
const { states, opcodes, sentCloseFrameState } = require('undici/lib/web/websocket/constants')
const { webidl } = require('undici/lib/web/webidl')
const { getURLRecord, isValidSubprotocol, isEstablished, utf8Decode } = require('undici/lib/web/websocket/util')
const { establishWebSocketConnection, failWebsocketConnection, closeWebSocketConnection } = require('undici/lib/web/websocket/connection')
const { channels } = require('undici/lib/core/diagnostics')
const { WebsocketFrameSend } = require('undici/lib/web/websocket/frame')
const { ByteParser } = require('undici/lib/web/websocket/receiver')
const { WebSocketError, createUnvalidatedWebSocketError } = require('undici/lib/web/websocket/stream/websocketerror')
const { utf8DecodeBytes } = require('undici/lib/web/fetch/util')
...
class WebSocketStream {
  ...
  /** @type {import('undici/lib/util/promise').DeferredPromise} */
  #openedPromise
  ...
  /** @type {import('undici/lib/web/websocket/websocket').Handler} */
  #handler = {
  ...
  /** @type {import('undici/lib/web/websocket/receiver').ByteParser} */
  #parser
  ...
  /** @type {import('undici/lib/web/websocket/websocket').Handler['onConnectionEstablished']} */
  ...
  /** @type {import('undici/lib/web/websocket/websocket').Handler['onMessage']} */
  #onMessage (type, data) {
  ...
  /** @type {import('undici/lib/web/websocket/websocket').Handler['onSocketClose']} */
  #onSocketClose () {
    const wasClean =
