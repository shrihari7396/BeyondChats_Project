...
const { uid, states, sentCloseFrameState, emptyBuffer, opcodes } = require('undici/lib/web/websocket/constants')
const { parseExtensions, isClosed, isClosing, isEstablished, validateCloseCodeAndReason } = require('undici/lib/web/websocket/util')
const { makeRequest } = require('undici/lib/web/fetch/request')
const { fetching } = require('undici/lib/web/fetch')
const { Headers, getHeadersList } = require('undici/lib/web/fetch/headers')
const { getDecodeSplit } = require('undici/lib/web/fetch/util')
 ...
 * @param {import('undici/lib/web/websocket/websocket').Handler} handler
 * @param {Partial<import('undici/types/websocket').WebSocketInit>} options
 */
 ...
 * @param {import('undici/lib/web/websocket/websocket').Handler} object
