...
const { SnapshotRecorder } = require('undici/lib/mock/snapshot-recorder')
...
const { validateSnapshotMode } = require('undici/lib/mock/snapshot-utils')
...
class SnapshotAgent extends MockAgent {
   ...
   * @return {import('undici/lib/mock/snapshot-utils').SnapshotMode} - The current snapshot mode
   */
  getMode () {
   ...
   * @param {import('undici/lib/mock/snapshot-recorder').SnapshotRequestOptions} requestOpts - Request options to identify the snapshot
   ...
   * @returns {import('undici/lib/mock/snapshot-recorder').SnapshotInfo|null} - Snapshot information or null if not found
   */
   ...
   * @param {Array<{hash: string; snapshot: import('undici/lib/mock/snapshot-recorder').SnapshotEntryshotEntry}>|Record<string, import('./snapshot-recorder').SnapshotEntry>} snapshotData - New snapshot data to replace existing snapshots
   * @returns {void}
   */
