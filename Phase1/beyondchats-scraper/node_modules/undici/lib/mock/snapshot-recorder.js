...
const { InvalidArgumentError, UndiciError } = require('undici/lib/core/errors')
const { hashId, isUrlExcludedFactory, normalizeHeaders, createHeaderFilters } = require('undici/lib/mock/snapshot-utils')
 ...
 * @property {import('undici/lib/mock/snapshot-utils').Headers|import('./snapshot-utils').UndiciHeaders} headers - Request headers
 * @property {import('undici/lib/mock/snapshot-utils').NormalizedHeaders} _normalizedHeaders - Request headers as a lowercase object
 ...
 * @property {import('undici/lib/mock/snapshot-utils').NormalizedHeaders} headers - Normalized headers as a lowercase object
 * @property {string|Buffer} [body] - Request body (optional)
 */
 ...
 * @property {import('undici/lib/mock/snapshot-utils').NormalizedHeaders} headers - Normalized response headers as a lowercase object
 ...
 * @property {import('undici/lib/mock/snapshot-utils').SnapshotMode} [mode='record'] - Mode: 'record' or 'playback'
 ...
 * @param {import('undici/lib/mock/snapshot-utils').HeaderFilters} headerFilters - Cached header sets for performance
 ...
 *
 * @param {import('undici/lib/mock/snapshot-utils').Headers} headers - Headers to filter
 * @param {import('undici/lib/mock/snapshot-utils').HeaderFilters} headerFilters - Cached sets for ignore, exclude, and match headers
...
class SnapshotRecorder {
  ...
  /** @type {import('undici/lib/mock/snapshot-utils').IsUrlExcluded} */
  #isUrlExcluded
  ...
  /** @type {import('undici/lib/mock/snapshot-utils').HeaderFilters} */
  #headerFilters
