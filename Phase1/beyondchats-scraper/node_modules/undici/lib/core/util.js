...
const timers = require('undici/lib/util/timers')
 ...
 * @returns {asserts handler is import('undici/lib/api/api-request').RequestHandler}
 */
...
/**
 * @param {import ('undici/lib/dispatcher/client')} client
 * @param {import ('undici/lib/core/request')} request
 * @param {Error} err
 */
