...
const { serializePathWithQuery } = require('undici/lib/core/util')

/**
 * @param {import('undici/types/dispatcher.d.ts').default.DispatchOptions} opts
 */
 ...
 * @returns {import('undici/types/cache-interceptor.d.ts').default.CacheControlDirectives}
 */
function parseCacheControlHeader (header) {
  /**
   * @type {import('undici/types/cache-interceptor.d.ts').default.CacheControlDirectives}
   */
  const output = {}
...
/**
 * @param {unknown} store
 * @returns {asserts store is import('undici/types/cache-interceptor.d.ts').default.CacheStore}
 */
 ...
 * @returns {asserts methods is import('undici/types/cache-interceptor.d.ts').default.CacheMethods[]}
 */
